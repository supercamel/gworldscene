...
GWorldScene is built with Meson and Ninja. The library depends on GTK 4,
GObject Introspection, epoxy, GDAL, Assimp, libsoup 3, GLM, zlib, and
gdk-pixbuf.
...
.. code-block:: text
   ...
   /usr/lib/aarch64-linux-gnu/libgworldscene-0.1.so
   /usr/lib/aarch64-linux-gnu/girepository-1.0/GWorldScene-0.1.typelib
   /usr/share/gir-1.0/GWorldScene-0.1.gir
   /usr/share/vala/vapi/GWorldScene-0.1.vapi
   /usr/include/gworldscene-0.1/gworldscene/
   /usr/lib/aarch64-linux-gnu/pkgconfig/gworldscene-0.1.pc
...
.. code-block:: sh
   ...
   sqgi examples/sqgi/introspection.nut
